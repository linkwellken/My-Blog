            ...
            <section className="container mx-auto">
                ...
                <section className="grid grid-cols-2 gap-8">
                    ...
                    <article className="relative rounded-lg shadow-xl bg-white p-16">
                        <h3 className="text-gray text-3xl font-bold mb-2 hover:text-orange-700">
                        ...
                        <div className="text-gray-500 text-xs space-x-4">
                            ...
                            <a href={project.link} rel="noopener noreferrer" target="_blank" className="text-gray-500 font-bold hover:underline hover:text-orange-500 text-xl">
                                View The Project
                            </a>
